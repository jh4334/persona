...
def make_student_desk() -> Image.Image:
    ...
    surface.rounded((7, 1, 33, 11.5), 2.5, WOOD, WOOD_DARK, 0.9)
    surface.line(((11, 4), (29, 4)), WOOD_DARK, 0.8)
    surface.rounded((9, 9, 31, 11.5), 1, WOOD_DARK, DARK, 0.5)
    surface.polygon(((2, 18), (27, 12), (39, 18), (13, 27)), WOOD_LIGHT, WOOD_DARK, 1)
    surface.polygon(((2, 18), (13, 27), (13, 32), (2, 24)), WOOD_DARK, DARK, 0.8)
    surface.polygon(((13, 27), (39, 18), (39, 24), (13, 33)), WOOD, WOOD_DARK, 0.8)
    surface.rounded((7, 28, 12, 40), 1.4, WOOD_DARK, DARK, 0.7)
    surface.rounded((32, 25, 37, 38), 1.4, WOOD_DARK, DARK, 0.7)
    return surface.image
